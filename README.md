...
- [x] [herdr](https://github.com/ogulcancelik/herdr) — agent multiplexer, installed via Homebrew
...
- [x] Compilers / language runtimes
  ...
  - [x] [uv](https://docs.astral.sh/uv/) — Python package and project manager
...
- [x] [droast](https://github.com/immanuwell/dockerfile-roast) — opinionated Dockerfile linter
